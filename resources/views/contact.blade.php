...
@section('title', 'Contact Us - Ken Relocation')
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="contact-form">
                        ...
                        <form class="custom-contact-form" method="post" action="/contact" onsubmit="disableSubmitButton(this)">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-md-12 col-lg-12">
                                    <button type="submit" style="float: left;" class="cmn-btn btn">Send Message</button>
                    ...
                    <div class="contact-place">
                        ...
                        <div class="contact-item">
                            ...
                            <ul>
                                ...
                                <li>
                                    <span>Gmail:</span>
                                    <a href="mailto:kenrelocation@gmail.com">kenrelocation@gmail.com</a>
                                </li>
                            </ul>
                        </div>
                    </div>
